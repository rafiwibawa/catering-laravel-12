...
<head>
    ...
    <style>
        ...
        .btn-custom-login:hover {
            background-color: #e6a900; /* lebih gelap dari #ffbe32 */
            border-color: #e6a900;
            color: #fff;
        }
  ...
  color: white;
  font-weight: normal; /* jangan bold, agar mirip */
...
<body style="background: url('{{ asset('cms/img/bg-login.jpeg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
            ...
            <div class="col-xl-6 col-lg-12 col-md-9 mt-5">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            {{-- <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background: url('{{ asset('cms/img/login.jpeg') }}')"></div> --}}
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4 font-greatvibes">Rumah Makan Anni</h1>
                                    </div>
                                    ...
                                    <form class="user" action="/admin/login" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-block btn-custom-login">
                                            Login
                                        </button> 
                                        <hr> 
                                    </form> 

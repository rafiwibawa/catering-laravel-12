        ...
        var _componentPage = function(){
            ...
            initAction = () => {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          $.ajax({
                              ...
                              error: function(xhr) {
                                  toastr.error('Gagal menghapus admin');
                              }
                          });
                      }
                  });
              ...
              $(document).on('click', '.btn-edit', function(e) {
                  ...
                  if (data) {
                      $('#modalCompanyLabel').text('Edit admin');
                      $('#admin_form').attr('action', `/admin/users/${data.id}`);
                      $('#admin_form').attr('method', 'POST'); 
                      $('#admin_form').find('input[name="_method"]').remove(); 
                      $('#admin_form').append('<input type="hidden" name="_method" value="PUT">');
                      $('#admin_form')[0].reset();
              ...
              $('#btnAddAdmin').on('click', function() { 
                  $('#modalCompanyLabel').text('Tambah Admin');
                  $('#admin_form').attr('action', "{{ url('/admin/users') }}");
                  $('#admin_form').attr('method', 'POST');
                  $('#admin_form').find('input[name="_method"]').remove();
                  $('#admin_form')[0].reset(); 
